...
- Status: The playback experiment is complete on `verify/bundled-mpv`; main remains unchanged and the release job was skipped. Native runtime/source caching is now implemented and undergoing cold/warm CI verification. Temporary diagnostic workflows and scripts were removed. Do not merge or publish without the owner's decision; upstream prebuilt binaries remain deferred.
