...
- Status: The experiment is complete on `verify/bundled-mpv`; main remains unchanged and the release job was skipped. Temporary diagnostic workflows and scripts were removed. Do not merge or publish without the owner's decision; reusable runtimes, caching, and upstream binaries remain deferred.
