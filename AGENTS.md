...
- Status: Playback and native runtime/source caching are verified on `verify/bundled-mpv`; main remains unchanged and release jobs were skipped. Temporary diagnostic workflows and scripts were removed. Do not merge or publish without the owner's decision; upstream prebuilt binaries remain deferred.
